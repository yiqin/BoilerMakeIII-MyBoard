...
class DOAlertController : UIViewController, UITextFieldDelegate, UIViewControllerTransitioningDelegate {
    ...
    private var alertViewWidth: CGFloat = 280.0
    private var alertViewHeightConstraint: NSLayoutConstraint!
    private var alertViewPadding: CGFloat = 25.0
    ...
    var buttonFont: [DOAlertActionStyle : UIFont!] = [
        .Default : UIFont(name: "Avenir Next", size: 16),
        .Cancel  : UIFont(name: "Avenir Next", size: 16),
        .Destructive  : UIFont(name: "Avenir Next", size: 16)
    ]
